...
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(run_mcmc(nIter, burnin, thin, n, nsamp, ninit, metropolis, convex, npoint, dirichlet, proportion_model, BVS, gamma_prior, gamma_sampler, eta_prior, eta_sampler, initList, rangeList, hyperparList, datEvent, datTime, datX, datX0, datProportionConst));
