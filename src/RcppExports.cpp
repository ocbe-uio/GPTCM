...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< bool >::type CMH(CMHSEXP);
    ...
    rcpp_result_gen = Rcpp::wrap(run_mcmc(nIter, burnin, thin, tick, n, nsamp, ninit, convex, npoint, dirichlet, proportion_model, BVS, CMH, threads, gamma_prior, gamma_sampler, eta_prior, eta_sampler, initList, rangeList, hyperparList, datEvent, datTime, datX, datX0, datProportionConst));
